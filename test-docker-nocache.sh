...
check_200 "http://localhost:5000/emulator"               "Emulator tab page"
check_200 "http://localhost:5000/emulator/shell/"        "Emulator shell HTML"
check_200 "http://localhost:5000/emulator/shell/jzintv.js"   "Emulator JS"
