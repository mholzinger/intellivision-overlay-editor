...
echo ""
echo "🕹️  Emulator endpoints..."
check_200 "http://localhost:5000/emulator/" "Emulator shell page"
check_200 "http://localhost:5000/emulator/jzintv.js" "Emulator JS"
check_200 "http://localhost:5000/emulator/jzintv.wasm" "Emulator WASM"
check_200 "http://localhost:5000/emulator/jzintv.data" "Emulator data"
