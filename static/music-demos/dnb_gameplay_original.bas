...
'
' Ch1 = Melodic fragments (clarinet X — cuts through PSG mix)
' Ch2 = Bass line (bass Z — locked to kick pattern)
' Drums = M1(kick), M2(snare), M3(hat)
'
' Tempo 6 (~120 BPM, driving but not frantic)
' PLAY SIMPLE NO DRUMS would free noise channel too,
' but we WANT the drum patterns here.
'
' Estimated: ~196 words (12 bars × 16 steps + overhead)
' ============================================================
...
GridRunner_loop:
  ...
  ' --- Bar 7: Em return, melody drops octave ---
  MUSIC E4X, E2Z, -, M1
  MUSIC -,   S,   -, M3
  MUSIC G4X, -,   -, M3
  MUSIC -,   -,   -, M3
